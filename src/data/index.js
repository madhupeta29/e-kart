export const data = {
  banner: [
    ...
    {
      to: "/link",
      img: "../../images/banner/50-Banner.webp",
      title: "Best educational  Instiyution",
  ...
  iconProducts: [
    {
      to: "/product/detail",
      img: "blueGrad",
      title: "IOT Certifaication On Azure",
      text: " Upto 20% off",
      tips: "Sony, Dell, Lenovo dddd",
      cssClass: "display-1 text-primary",
    },
    {
      to: "/product/detail",
      img: "redGrad",
      title: "HeLinux Administration Certifiacation",
      text: " Upto 50% off",
    ...
    },
    {
      to: "/product/detail",
      img: "greenGrad",
      title: "Design Patterns & Algoithams",
      text: " Upto 20% off",
      tips: "Sony, Dell, Lenovo",
